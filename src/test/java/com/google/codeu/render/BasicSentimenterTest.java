...
public class BasicSentimenterTest {
   ...
   *  True means score is positive or > 0. 
   *  False means score is negative.
   * @throws IOException */
  private void runReviewSentimenterTest(
      ReviewSentimenter reviewSentimenter, String inputText, boolean expectedSign) throws IOException {
